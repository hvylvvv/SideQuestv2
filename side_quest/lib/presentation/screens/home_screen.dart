          ...
          setState(() {
            recommendedPlaces = (jsonResponse["recommendations"] as List).map((place) {
              return {
                ...
                "rating": place["rating"] != null ? place["rating"].toString() : "No rating",
                "types": place["types"] ?? [],
                "image": place["image"] ?? "",
              };
            }).toList();
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.emoji_events, color: Colors.black54, size: 24),
                SizedBox(width: 5),
  ...
  Widget _buildCategoryButton(String imagePath, String label) {
    return Column(
      children: [
        ...
        SizedBox(height: 5),
        Text(label, textAlign: TextAlign.center, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
      ],
    );
  }
          ...
          children: [
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => FoodFeatsChallenge()),
                );
              },
              child: _buildCategoryButton("assets/icons/foodiefeast.png", "Foodie Feasts"),
            ),
